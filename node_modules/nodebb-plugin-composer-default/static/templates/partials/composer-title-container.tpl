<div class="title-container align-items-center gap-2 d-flex">
	...
	<div class="{{{ if !template.compose }}}d-none d-md-flex{{{ else }}}d-flex{{{ end }}} action-bar gap-1 align-items-center">
		<div class="anonymous-checkbox d-flex align-items-center me-3">
        <input type="checkbox" id="anonymous" name="anonymous" class="me-1">
        <label for="anonymous" class="mb-0">Anonymous</label>
    </div>
