...
topicsController.updateAnsweredStatus = async function (req, res, next) {
    const pid = req.params.pid; // Post ID from URL params
    ...
    try {
        // Call the backend function to update the post's 'isAnswered' status
